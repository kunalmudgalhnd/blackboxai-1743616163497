    ...
    <footer className="bg-primary text-white py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Groozo</h3>
            <p className="text-gray-300">Your instant grocery delivery partner. Get fresh groceries delivered in 30 minutes or less.</p>
          ...
          <div>
            ...
            <address className="text-gray-300 not-italic">
              ...
              <p className="mt-2">Email: info@groozo.com</p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Groozo. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
